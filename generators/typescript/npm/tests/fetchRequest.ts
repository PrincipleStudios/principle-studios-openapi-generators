...
import { AdapterRequestArgs, AdapterResponseArgs } from "~/src/inputs-outputs";
...
function fetchRequest<TParams extends {}, TBody extends RequestBodies, TResponse extends StandardResponse, TCallType extends TransformCallType>(
    ...
    async function transform(params: TParams, body: TBody[any] | null = null, mimeType: string | null = null): Promise<TResponse> {
        const requestOpts: AdapterRequestArgs = conversion.request(params, body!, mimeType!);
...
type RequestToResponseTransform = (input: RequestConversion<any, any, any, any, any, any>) => Converted<RequestConversion<any, any, any, any, any, any>>;

type Converted2<TConversion extends RequestConversion<any, any, any, any, any, any>, TTransform extends RequestToResponseTransform> =
    TConversion extends RequestConversion<any, any, infer TParams, infer TBody, infer TResponse, infer TCallType> ?
        TransformRequest<
            TParams,
            TBody,
            TCallType,
            TTransform extends (input: RequestConversion<any, any, TParams, TBody, TResponse, TCallType>) => TransformRequest<TParams, TBody, TCallType, infer TConvertedResponse>
                ? TConvertedResponse
                : unknown
        > : never;
