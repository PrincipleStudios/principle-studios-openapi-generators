...
{ 
    public abstract class InfoControllerBase : global::Microsoft.AspNetCore.Mvc.ControllerBase
    {
        ...
        // Another Response
        [global::Microsoft.AspNetCore.Mvc.ProducesDefaultResponseType()] // 
        // Sample Response
        [global::Microsoft.AspNetCore.Mvc.ProducesResponseType(200, Type = typeof(global::System.Collections.Generic.Dictionary<string, string>))] // application/json
        // Sample Response
        ...
        public async global::System.Threading.Tasks.Task<global::Microsoft.AspNetCore.Mvc.IActionResult> GetInfoTypeSafeEntry(
            [global::Microsoft.AspNetCore.Mvc.FromHeader(Name = "X-Data"), global::System.ComponentModel.DataAnnotations.Required] byte[] xData
        ) => (await GetInfo(xData)).ActionResult;
        ...
        public readonly struct GetInfoActionResult
        {
            ...
            /// Sample Response
            /// </summary>
            public static GetInfoActionResult Ok(global::System.Collections.Generic.Dictionary<string, string> result,
                string headerXData) =>
                new GetInfoActionResult(200, "application/json", typeof(global::System.Collections.Generic.Dictionary<string, string>), result,
                    new global::System.Collections.Generic.KeyValuePair<string, string>("X-Data", headerXData));
            
            /// <summary>
            /// Sample Response
            /// </summary>
            public static GetInfoActionResult NoContent(string headerXData) =>
                new GetInfoActionResult(204,
                    new global::System.Collections.Generic.KeyValuePair<string, string>("X-Data", headerXData));
            
            
            public static GetInfoActionResult OtherStatusCode(int statusCode,
                string headerXData,
                string headerXDiag) =>
                new GetInfoActionResult(statusCode,
                    new global::System.Collections.Generic.KeyValuePair<string, string>("X-Data", headerXData),
                    new global::System.Collections.Generic.KeyValuePair<string, string>("X-Diag", headerXDiag));
