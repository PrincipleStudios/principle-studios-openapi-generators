...
{ 
    public abstract class RedirectControllerBase : global::Microsoft.AspNetCore.Mvc.ControllerBase
    {
        
        [global::Microsoft.AspNetCore.Mvc.HttpGet]
        [global::Microsoft.AspNetCore.Mvc.Route("/redirect")]
        // Redirection Response
        [global::Microsoft.AspNetCore.Mvc.ProducesResponseType(302)] // 
        public async global::System.Threading.Tasks.Task<global::Microsoft.AspNetCore.Mvc.IActionResult> RedirectTypeSafeEntry(
            
        ) => (await Redirect()).ActionResult;

        protected abstract global::System.Threading.Tasks.Task<_RedirectActionResult> Redirect();

        public readonly struct _RedirectActionResult
        {
            ...
            private _RedirectActionResult(global::Microsoft.AspNetCore.Mvc.IActionResult ActionResult, global::System.Collections.Generic.KeyValuePair<string, string>[] headers)
            {
                this.ActionResult = new HeaderActionResult(ActionResult, headers);
            }

            private _RedirectActionResult(int statusCode, params global::System.Collections.Generic.KeyValuePair<string, string>[] headers)
                : this(new global::Microsoft.AspNetCore.Mvc.StatusCodeResult(statusCode), headers)
            {
            }

            private _RedirectActionResult(int statusCode, string mediaType, global::System.Type declaredType, object? resultObject, params global::System.Collections.Generic.KeyValuePair<string, string>[] headers)
            ...
            /// Redirection Response
            /// </summary>
            public static _RedirectActionResult Redirect(string headerLocation) =>
                new _RedirectActionResult(302,
                    new global::System.Collections.Generic.KeyValuePair<string, string>("Location", headerLocation));
            

            /// <summary>Allows for action results not specified in the API</summary>
            public static _RedirectActionResult Unsafe(global::Microsoft.AspNetCore.Mvc.IActionResult actionResult, params global::System.Collections.Generic.KeyValuePair<string, string>[] headers) =>
                new _RedirectActionResult(actionResult, headers);
        }
    }
}