...
{ 
    public abstract class ControllerBase : global::Microsoft.AspNetCore.Mvc.ControllerBase
    {
        
        /// <param name="testForRegexBody"></param>
        ...
        public async global::System.Threading.Tasks.Task<global::Microsoft.AspNetCore.Mvc.IActionResult> TestForRegexTypeSafeEntry(
            [global::Microsoft.AspNetCore.Mvc.FromBody, global::System.ComponentModel.DataAnnotations.Required, global::System.ComponentModel.DataAnnotations.RegularExpression(@"""foo""")] string testForRegexBody
        ) => (await TestForRegex(testForRegexBody)).ActionResult;

        protected abstract global::System.Threading.Tasks.Task<TestForRegexActionResult> TestForRegex(
            string testForRegexBody);

        public readonly struct TestForRegexActionResult
        {
            ...
            private TestForRegexActionResult(global::Microsoft.AspNetCore.Mvc.IActionResult ActionResult, global::System.Collections.Generic.KeyValuePair<string, string>[] headers)
            {
                this.ActionResult = new HeaderActionResult(ActionResult, headers);
            }

            private TestForRegexActionResult(int statusCode, params global::System.Collections.Generic.KeyValuePair<string, string>[] headers)
                : this(new global::Microsoft.AspNetCore.Mvc.StatusCodeResult(statusCode), headers)
            {
            }

            private TestForRegexActionResult(int statusCode, string mediaType, global::System.Type declaredType, object? resultObject, params global::System.Collections.Generic.KeyValuePair<string, string>[] headers)
            ...
            /// OK
            /// </summary>
            public static TestForRegexActionResult Ok() =>
                new TestForRegexActionResult(200);
            

            /// <summary>Allows for action results not specified in the API</summary>
            public static TestForRegexActionResult Unsafe(global::Microsoft.AspNetCore.Mvc.IActionResult actionResult, params global::System.Collections.Generic.KeyValuePair<string, string>[] headers) =>
                new TestForRegexActionResult(actionResult, headers);
        }
    }
}